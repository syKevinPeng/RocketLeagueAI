...
class GameState(object):
    ...
    def set_vals_from_dict(self,state_dict):
        self.game_type =           state_dict['game_type']
        self.blue_score =          state_dict['blue_score']
        self.orange_score =        state_dict['orange_score']
        self.last_touch =          state_dict['last_touch']
        self.players =             state_dict['players']
        self.ball =                state_dict['ball']
        self.inverted_ball =       state_dict['inverted_ball']
        self.boost_pads =          state_dict['boost_pads']
        self.inverted_boost_pads = state_dict['inverted_boost_pads']
