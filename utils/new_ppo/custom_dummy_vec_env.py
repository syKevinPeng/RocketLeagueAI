...
class DummyVecEnv(VecEnv):
    ...
    def __init__(self, env_fns: List[Callable[[], gym.Env]], num_exer: int):
    ...
    def step(self, actions: np.ndarray, reset_at_term_exer=False, which_exer=0, exercise_reset_states=None) -> VecEnvStepReturn:
        """
    ...
    def step_wait(self, reset_at_term_exer=False, which_exer=0, exercise_reset_states=None) -> VecEnvStepReturn:
