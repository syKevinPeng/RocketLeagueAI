...
from utils.new_ppo.custom_monitor import Monitor
from utils.new_ppo.custom_dummy_vec_env import DummyVecEnv
...
class BaseAlgorithm(ABC):
    ...
    def _wrap_env(env: GymEnv, verbose: int = 0, monitor_wrapper: bool = True) -> VecEnv:
        ...
        if not isinstance(env, VecEnv):
            ...
            env = DummyVecEnv([lambda: env], num_exer=num_exer)
