...
class Monitor(gym.Wrapper):
    ...
    def step(self, action: Union[np.ndarray, int], reset_at_term_exer=False, which_exer=None, exercise_reset_states=None) -> GymStepReturn:
        ...
        # print('step inside Monitor', reset_at_term_exer, self.env, type(self.env))

        if reset_at_term_exer:
            observation, reward, done, (done_exer,exer_state), info = self.env.step(action,
                                                                                    reset_at_term_exer,
                                                                                    which_exer,
        ...
        # if reset_at_term_exer and done_exer:
        #     observation = self.env.reset_to_exer_state(exer_state)
        ...
        if reset_at_term_exer:
            return observation, reward, done, (done_exer,exer_state), info
